...
"""
 Creamomos un lista de diccionario con las palabras utilizadas con mayor frecuencia,
 otra tabla con las frecuencias y otra con los datos de zipfian
"""
...
def _remove_punctuation(text):
    ...
    """
    removemos los caracteres especiales del texto como : 
    !\"#$%&'()*+,-./:;<=>?@[\]^_`{|}~0123456789  
    """
...
def _top_word_frequencies(text, top):
    ...
    """
    Creamos una lista de tuplas que contenga las palabras más frecuentes y 
    sus frecuencias en orden descendente. 
    """
...
def _create_zipf_table(frequencies):
    ...
    """
  Toma la lista creada por _top_word_frequencies y la 
  inserta en una lista de diccionarios, junto con los datos 
  de Zipfian.
    """
...
def print_zipf_table(zipf_table):
    ...
    """
    Imprime la lista creada por generate_zipf_table en formato de 
    tabla con encabezados de columna.
    """
